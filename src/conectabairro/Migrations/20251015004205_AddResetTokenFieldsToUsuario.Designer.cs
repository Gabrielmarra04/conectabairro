...
namespace conectabairro.Migrations
{
    ...
    [Migration("20251015004205_AddResetTokenFieldsToUsuario")]
    partial class AddResetTokenFieldsToUsuario
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("conectabairro.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$13$8eV09/7yAsbTTXWKkGhdk.5cHAy7FH3A00nNNnINVRZrPVI6NZWOq",
                            Rua = "N/A",
                            Telefone = "",
                            TipoUsuarios = 0
                        });
